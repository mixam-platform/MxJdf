...
public enum SubProductType {
    ...
    PRODUCT_WEDDING_BOOK(100014),
    PRODUCT_YEARBOOK(100015),
    PRODUCT_COOKBOOK(100016),
    PRODUCT_COLOURINGBOOK(100017),
    PRODUCT_ARTBOOK(100018),
    PRODUCT_GRAPHIC_NOVEL(100019),
    PRODUCT_LOOKBOOK(100020);
