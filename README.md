...
|subProduct|Fine classification of the product. (optional) (SubProductType)|PRODUCT_HARD_COVER_BOOKS(100001)<br>PRODUCT_PAPERBACK_BOOKS(100002)<br>PRODUCT_PERFECT_BOOKLETS(100003)<br>PRODUCT_WIRO_BOOKLETS(100004)<br>PRODUCT_LOOP_BOOKLETS(100005)<br>PRODUCT_STAPLED_BOOKLETS(100006)<br>PRODUCT_MAGAZINES(100007)<br>PRODUCT_CATALOGS(100008)<br>PRODUCT_BOOKLETS(100009)<br>PRODUCT_ZINES(100010)<br>PRODUCT_COMIC_BOOKS(100011)<br> PRODUCT_ART_PRINTS(100012)<br>PRODUCT_MANGA(100013)<br>PRODUCT_WEDDING_BOOK(100014)<br>PRODUCT_YEARBOOK(100015)<br>PRODUCT_COOKBOOK(100016)<br> PRODUCT_COLOURINGBOOK(100017)<br> PRODUCT_ARTBOOK(100018)<br> PRODUCT_GRAPHIC_NOVEL(100019)<br> PRODUCT_LOOKBOOK(100020);|
...
|type|(MaterialType)|INVALID(0)<br>SILK(1)<br>GLOSS(2)<br>UNCOATED(3)<br>AFFICHE_PAPER(4)<br>OUTDOOR_PAPER(5)<br>ILLUSTRATION_PRINTING_PAPER(6)<br>PHOTOGRAPHIC_PRINTING_PAPER(7)<br>POSTCARD_BOARD(8)<br>NATURAL_PAPER(9)<br>RECYCLED_PAPER(10)<br>MATT(11)|
...
|ribbon|Ratchford  (RibbonType)|NONE(0), <br>WHITE(1), <br>CREAM(2), <br>GOLD(3), <br>ORANGE(4), <br>RED(5), <br>MAROON(6), <br>PINK(7), <br>PURPLE(8), <br>LIGHT_BLUE(9), <br>BLUE(10), <br>NAVY_BLUE(11), <br>GREEN(12), <br>DARK_GREEN(13), <br>GREY(14), <br>BLACK(15)|
